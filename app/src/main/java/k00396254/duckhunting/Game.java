...
public class Game {
    ...
    public Game (Rect newDuckRect, int newBulletRadius, float newDuckSpeed,
    ...
    public void setCannon (Point newCannonCenter, int newCannonRadius, int newBarrellength, int newBarrelRadius) {
